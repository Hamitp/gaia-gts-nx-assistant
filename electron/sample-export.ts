...
const project: GaiaProject = {
  ...
  location: "İstanbul",
  client: "GAIA QA",
  description: "Üç analiz ve iki jeoteknik birimle kanonik çıktı parite doğrulaması.",
  coordinateSystem: "ITRF96 / TM30",
  verticalDatum: "TUDKA",
  selectedAnalysisIds: ["nonlinear-static", "construction-stage", "strength-reduction"],
  groundUnits: [
